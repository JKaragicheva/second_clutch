...
points(jitter(Clutch)~jitter(DayFirst), pch=21, col=grey(0.2), data=Res[Res$DoubleBreeders==1 & Res$DayDiff==0,], bg=grey(0.4))

points(jitter(Clutch)~jitter(DayFirst+DayDiff), pch=21, col=grey(0.2), data=Res[Res$DayDiff>0,], bg=grey(0.9))

points(jitter(Clutch)~jitter(DayFirst), pch=".", cex=2, col=grey(0.2), data=Res[!Res$DoubleBreeders==1,])
