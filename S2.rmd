...
# model
for (row in 1:nrow) {
log(lamda[row])<- Intercept+InterceptDoubleBreeders*DoubleBreeders[row]+ # Intercept fixed
...
# model
for (row in 1:nrow) {
log(lamda[row])<- Intercept+w_int_double*InterceptDoubleBreeders*DoubleBreeders[row]+
